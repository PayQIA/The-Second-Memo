								...
								<div className="mt-auto pt-4">
									...
									>
										<svg
											...
											xmlns="http://www.w3.org/2000/svg"
										>
											<title>Add to The Second Memo</title>
										...
										{saving ? "Saving..." : "Add to the-second-memo"}
									</button>
									{saveError && (
								...
								{manualImportProvider ? (
									...
									<div className="flex flex-col gap-3">
										<ImportCard
											...
											description="Open 'view and manage' > save your memories to the-second-memo"
											onClick={() => {
												chrome.tabs.create({
										...
										<ImportCard
											...
											description="Open 'manage' > save your memories to the-second-memo"
											onClick={() => {
												chrome.tabs.create({
										...
										<ImportCard
											...
											description="Open 'Memory from your chats' > save your memories to the-second-memo"
											onClick={() => {
												chrome.tabs.create({
							...
							<div className="mb-8">
								...
								<ul className="list-none p-0 m-0 text-left">
									<li className="py-1.5 text-sm text-neutral-400 relative pl-5 before:content-['-'] before:absolute before:left-0 before:text-neutral-500 before:font-bold">
										Save any page to your the-second-memo
									</li>
									<li className="py-1.5 text-sm text-neutral-400 relative pl-5 before:content-['-'] before:absolute before:left-0 before:text-neutral-500 before:font-bold">
						...
						<div className="mt-8">
							<p className="m-0 mb-4 text-sm text-neutral-400">
								...
								<button
									...
									onClick={() => {
										window.open("mailto:support@the-second-memo.ai", "_blank")
									}}
									type="button"
								>
									Reach Out to Us
							...
							<button
								...
								onClick={() => {
									chrome.tabs.create({
										url: getThe Second MemoLoginUrl(),
									})
								}}
								type="button"
							>
