...
/**
 * The Second Memo API payload for storing memories
 */
...
export class The Second MemoAPIError extends ExtensionError {
	constructor(message: string, statusCode?: number) {
		super(message, "SECONDMEMO_API_ERROR", statusCode)
