...
export const API_ENDPOINTS = {
	SECONDMEMO_API: import.meta.env.PROD
		? "https://api.the-second-memo.ai"
		: "http://localhost:8787",
	SECONDMEMO_WEB: import.meta.env.PROD
		? "https://app.the-second-memo.ai"
		: "http://localhost:3000",
} as const

export function getThe Second MemoLoginUrl(): string {
	const baseUrl = API_ENDPOINTS.SECONDMEMO_WEB
...
export const ELEMENT_IDS = {
	...
	SECONDMEMO_TOAST: "sm-toast",
	SECONDMEMO_SAVE_BUTTON: "sm-save-button",
