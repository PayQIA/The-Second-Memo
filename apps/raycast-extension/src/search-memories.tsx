...
import { withThe Second Memo } from "./withThe Second Memo"
...
export default withThe Second Memo(Command)
function Command() {
		...
		>
			{hasSearched && !searchText.trim() ? (
				<List.EmptyView
					...
					description="Type to search through your The Second Memo collection"
				/>
			) : hasSearched ? (
				<List.EmptyView
					icon={Icon.Document}
