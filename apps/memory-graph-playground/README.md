...
A demo app showcasing the `@the-second-memo/memory-graph` package.
...
Open [http://localhost:3000](http://localhost:3000) and enter your The Second Memo API key.

## Usage Example

```tsx
import { MemoryGraph, type DocumentWithMemories } from '@the-second-memo/memory-graph'
