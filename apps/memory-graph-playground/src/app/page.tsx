...
import {
	...
	type MemoryRelation,
} from "@the-second-memo/memory-graph"
import { generateMockGraphData } from "@the-second-memo/memory-graph/mock-data"
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-sm text-zinc-400">
							Test the @the-second-memo/memory-graph package
						</p>
					</div>
					...
					<form onSubmit={handleSubmit} className="flex items-center gap-3">
						<input
							type="password"
							placeholder="Enter your The Second Memo API key"
							value={apiKey}
							onChange={(e) => {
