						...
						<div className="text-center">
							...
							>
								{pluginInfo?.description ??
									`Allow ${displayName} to access your The Second Memo account.`}
							</p>
						</div>
				...
				<div className={cardClass}>
					<div className="flex flex-col items-center gap-5">
						...
						<div className="text-center">
							...
							>
								{pluginInfo?.description ??
									`A paid plan is required to use ${displayName} with The Second Memo.`}
							</p>
						</div>
						...
						<a
							href="https://app.the-second-memo.ai/settings#billing"
							className={dmSans125ClassName(
				...
				<div className={cardClass}>
					<div className="flex flex-col items-center gap-4 text-center">
						...
						<div className="flex flex-col gap-2 w-full">
							...
							<a
								href="https://app.the-second-memo.ai"
								className={dmSans125ClassName(
									"text-[12px] text-[#737373] hover:text-[#FAFAFA] transition-colors",
								)}
							>
