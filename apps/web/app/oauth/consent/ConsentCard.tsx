...
> = {
	"the-second-memo-claude-code": { name: "Claude Code", icon: ClaudeDesktopIcon },
	"the-second-memo-opencode": { name: "OpenCode" },
	"the-second-memo-openclaw": { name: "OpenClaw" },
	"the-second-memo-codex": { name: "OpenAI Codex" },
}
