...
export default function ReferralPage() {
	...
	const referralLink = `https://the-second-memo.ai/ref/${referralCode}`
	...
	useEffect(() => {
		async function checkReferral() {
			...
			try {
				...
				setReferralData({
					valid: true,
					referrerName: "A the-second-memo user", // Placeholder - should come from API
				})
			} catch (error) {
	...
	const handleShare = () => {
		if (navigator.share) {
			navigator.share({
				title: "Join the-second-memo",
				text: "I'm excited about the-second-memo - it's going to change how we store and interact with our memories!",
				url: referralLink,
			})
		} else {
			handleCopyLink()
					...
					<CardContent>
						<div className="text-center">
							<Button asChild className="w-full">
								<Link href="https://the-second-memo.ai">Go to the-second-memo</Link>
							</Button>
						</div>
					</CardContent>
				</Card>
			...
			<div className="max-w-lg w-full space-y-6">
				...
				<Card className="bg-[#1a1f2a] border-white/10">
					<CardHeader className="text-center">
						...
						<CardTitle className="text-2xl font-bold text-white">
							You're invited to the-second-memo!
						</CardTitle>
						<CardDescription className="text-white/60 mt-2">
						...
						<div className="space-y-4">
							<div className="bg-[#0f1419] rounded-lg p-4 border border-white/10">
								...
								<p className="text-white/70 text-sm leading-relaxed">
									the-second-memo is an AI-powered personal knowledge base that
				...
				<Card className="bg-[#1a1f2a] border-white/10">
					<CardHeader>
						...
						<CardDescription className="text-white/60">
							Help others discover the-second-memo and earn priority access.
						</CardDescription>
					</CardHeader>
					<CardContent>
