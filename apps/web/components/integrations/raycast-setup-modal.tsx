...
const RAYCAST_STEPS: InstallStep[] = [
	...
	},
	{
		...
		description: "Open the The Second Memo extension page in the Raycast Store.",
	},
	{
		title: "Paste your key in Raycast preferences",
		description:
			"Open Raycast preferences → Extensions → The Second Memo, then paste the key above.",
	},
	{
		title: 'Run "Add Memory" or "Search Memories"',
		description: "Trigger Raycast and start using The Second Memo from anywhere.",
	},
]
