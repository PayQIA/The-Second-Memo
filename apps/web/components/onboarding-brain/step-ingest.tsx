...
const TOOL_OPTIONS: Record<BrainMode, [FlowTool, ...FlowTool[]]> = {
	// Team/company-brain onboarding is focused: just get The Second Memo into Slack.
			...
			<section className="py-4">
				<div className="mb-6 px-1">
					...
					<p className="mt-1.5 text-[15px] font-medium leading-[1.4] text-[#737373]">
						{mode === "team"
							? "Add The Second Memo to Slack so your team can ask in any channel."
	...
	return (
		<div>
				...
				title={
					connected ? (
						...
						<div className="flex items-start justify-between gap-3">
							<span className="pt-1">
								Add The Second Memo to your Slack workspace
							</span>
							{loading ? (
			...
			<StepRow
				...
				title={
					<>
						Mention <span className="text-[#4BA0FA]">@the-second-memo</span> in{" "}
						<span className="font-mono text-[12px]">#general</span>
					</>
				}
			/>
			<StepRow index={3} last title="Ask your brain to test it">
				<CopyCodeBlock code="@the-second-memo what do we know about [topic]?" />
			</StepRow>
		</div>
	)
}
