...
const MCP_CLIENTS: Array<{
	...
	},
	{
		key: "claude",
		name: "Claude Desktop",
		tagline: "Connect the-second-memo in Claude Desktop",
	...
	},
	{
		...
		simpleTitle: "Connect any MCP-capable app to the-second-memo",
		dev: true,
	},
]
...
}> = [
	{
		...
		items: () =>
			MCP_CLIENTS.map<MCPClientItem>((c) => ({
				...
				docsUrl: "https://the-second-memo.ai/docs/the-second-memo-mcp/introduction",
			})),
	},
	{
		label: "Plugins",
		...
		items: () => [
			{
				...
				pro: true,
				docsUrl: "https://the-second-memo.ai/docs/connectors/google-drive",
			},
			{
				kind: "connector",
				id: "notion",
				...
				simpleTitle: "All your Notion pages, in the-second-memo",
				icon: <Notion className="size-6" />,
				pro: true,
				docsUrl: "https://the-second-memo.ai/docs/connectors/notion",
			},
			{
				kind: "connector",
				id: "onedrive",
				...
				pro: true,
				docsUrl: "https://the-second-memo.ai/docs/connectors/onedrive",
			},
			{
				kind: "connector",
				id: "granola",
				...
				pro: true,
				docsUrl: "https://the-second-memo.ai/docs/connectors/granola",
			},
		],
	},
	{
...
const MCP_INFO_USE_CASES: InfoUseCase[] = [
	...
	},
	{
		...
		description:
			"Use the same The Second Memo account across MCP-compatible clients so memory follows the user between sessions.",
	},
	{
...
const ITEM_INFO_USE_CASES: Record<string, InfoUseCase[]> = {
	...
	"plugin-codex": [
		...
		},
		{
			...
			description:
				"Use the-second-memo-search, the-second-memo-save, and the-second-memo-forget when memory needs direct control.",
		},
	],
	"plugin-opencode": [
		{
	...
	"google-drive": [
		...
		},
		{
			...
			description:
				"Keep selected Drive files updated in The Second Memo, with scheduled and manual import support.",
		},
	],
	notion: [
		{
			...
			description:
				"Sync Notion pages, databases, and blocks into The Second Memo from connected workspaces.",
		},
		{
	...
	chrome: [
		{
			...
			description:
				"Capture webpages into The Second Memo while browsing instead of manually copying content.",
		},
		{
	...
	shortcuts: [
		...
		},
		{
			...
			description:
				"Send useful snippets and links into The Second Memo from native Apple workflows.",
		},
	],
	raycast: [
		{
		...
		},
		{
			...
			description:
				"Look up The Second Memo content directly from your desktop command bar.",
		},
	],
	"x-bookmarks": [
		{
			...
			description:
				"Turn X/Twitter bookmarks into searchable The Second Memo memories.",
		},
		{
					...
					<div className="flex shrink-0 items-center gap-3">
						...
						<div className="min-w-0 flex-1">
							...
							<p className="mt-0.5 truncate text-[12px] text-[#A1A1AA]">
								Use cases that apply to this The Second Memo connection.
							</p>
						</div>
...
export function IntegrationsView({
	...
	const { data: pluginsData } = useQuery({
		queryFn: async () => {
			const API_URL =
				process.env.NEXT_PUBLIC_BACKEND_URL ?? "https://api.the-second-memo.ai"
				...
				>
					...
					<div className="flex shrink-0 items-center gap-3">
						...
						<div className="min-w-0 flex-1">
							...
							<p className="mt-0.5 truncate text-[12px] text-[#A1A1AA]">
								Connect the-second-memo MCP to{" "}
								{activeMcpClient?.name ?? "your client"}.
							</p>
						</div>
						<div className="flex shrink-0 items-center gap-2">
							<a
								href="https://the-second-memo.ai/docs/the-second-memo-mcp/introduction"
								target="_blank"
								rel="noopener noreferrer"
								className={cn(
									dmSans125ClassName(),
