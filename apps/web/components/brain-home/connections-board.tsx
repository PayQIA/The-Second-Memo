					...
					<div className="min-w-0">
						...
						<p className="mt-1 truncate text-[12px] font-medium leading-[1.45] text-[#737373] sm:mt-0.5 sm:text-[13px] sm:leading-[1.5]">
							<span className="sm:hidden">
								Ask <span className="text-[#A1A1AA]">@the-second-memo</span> from
								any channel.
							</span>
							<span className="hidden sm:inline">
								Install The Second Memo so your team can{" "}
								<span className="text-[#A1A1AA]">@the-second-memo</span> in any
								channel.
							</span>
						</p>
					</div>
