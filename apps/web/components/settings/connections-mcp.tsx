			...
			<div className="flex flex-col items-center gap-4">
				<div className="flex flex-col items-center gap-2">
					...
					>
						...
						to get The Second Memo Connections
					</p>
				</div>
...
export default function ConnectionsMCP() {
		...
		onSuccess: (_data, variables) => {
			...
			toast.success(
				variables.deleteDocuments
					? "Connection removal has started. The Second Memo will permanently delete the documents in the next few minutes."
	...
	return (
		<div className="flex flex-col gap-8 w-full">
			{/* The Second Memo Connections Section */}
			<div className="flex flex-col gap-4">
				<SectionTitle badge={<ProBadge />}>
					The Second Memo Connections
				</SectionTitle>
			...
			{/* The Second Memo MCP Section */}
			<div className="flex flex-col gap-4">
				<SectionTitle>The Second Memo MCP</SectionTitle>
				...
				<ConnectionsCard>
					<div className="flex flex-col gap-4">
						...
						>
							...
							<a
								href="https://docs.the-second-memo.ai/the-second-memo-mcp/introduction"
								target="_blank"
						...
						>
							<Plus className="size-[10px] text-[#FAFAFA]" />
							<span className="text-[14px] tracking-[-0.14px] text-[#FAFAFA] font-medium">
								Connect your AI to The Second Memo
							</span>
						</PillButton>
					</div>
				</ConnectionsCard>
