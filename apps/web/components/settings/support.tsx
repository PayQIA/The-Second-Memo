...
const FAQS = [
	...
	},
	{
		...
		answer:
			"Connections let you sync documents from Google Drive, Notion, and OneDrive automatically. the-second-memo will index and make them searchable.",
	},
	{
...
export default function Support() {
	const handleMessageOnX = () => {
		window.open("https://x.com/the-second-memo", "_blank", "noopener,noreferrer")
	}

	const handleSendEmail = () => {
		window.location.href = "mailto:support@the-second-memo.com"
	}

	const handleJoinDiscord = () => {
		window.open(
			"https://the-second-memo.link/discord",
			"_blank",
			"noopener,noreferrer",
		)
	}
