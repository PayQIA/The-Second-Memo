...
const TIPS: Record<Profession, string[]> = {
	developer: [
		...
		"Drop in your last 3 PRs and ask The Second Memo for the review patterns",
	...
	research: [
		...
		"Save a paper once — The Second Memo finds it later by what it argued",
	...
	design: [
		...
		"Drop in 10 onboarding flows and ask The Second Memo for the common patterns",
	...
	medical: [
		...
		"Drop in three trials and ask The Second Memo for the methodological diffs",
	...
	default: [
		...
		"Save an idea — The Second Memo connects it to your earlier ones",
					...
					>
						...
						<div className="flex min-w-0 flex-1 items-baseline gap-2">
							...
							<p className="truncate text-[12px] text-fg-muted">
								{latestDigest.title || "Your week in The Second Memo"} ·{" "}
