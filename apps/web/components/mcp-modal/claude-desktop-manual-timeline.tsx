...
const STEPS: {
	...
	{
		step: 1,
		body: "Copy the the-second-memo block below. You will paste it inside mcpServers in a later step.",
	},
	{
		step: 2,
	...
	},
	{
		...
		imageAlt: "JSON editor showing the-second-memo mcpServers configuration",
	},
	{
		step: 5,
		body: "Restart Claude Desktop. Open Settings → Connectors, find the-second-memo, and click Configure.",
		imageSrc: GUIDE_IMAGES.step5,
		imageAlt:
			"Claude Desktop Connectors settings with the-second-memo and Configure highlighted",
	},
	{
		step: 6,
		body: "the-second-memo is installed in your Claude Desktop and ready to use.",
	},
]
