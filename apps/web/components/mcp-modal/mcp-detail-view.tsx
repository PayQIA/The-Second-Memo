								...
								<>
									{selectedClient === "mcp-url" && (
										<div className="space-y-2">
											...
											<McpCodeBlock
												code="https://mcp.the-second-memo.ai/mcp"
												onCopy={() => {
													analytics.mcpInstallCmdCopied()
													toast.success("Copied to clipboard!")
													setActiveStep(3)
									...
									{selectedClient === "cursor" && (
										<div className="space-y-4">
											<p className="text-[13px] leading-relaxed text-[#A1A1AA]">
												Open the link below to add the-second-memo in Cursor, or use
										...
										return (
											<div className="space-y-3">
												<p className="text-[13px] leading-relaxed text-[#A1A1AA]">
													...
													placeholder with an API key from the-second-memo settings
													(Integrations).
												</p>
												<McpCodeBlock
													code={snippet}
								...
								>
									...
									mcpClientShowsManual(detailSetup, effectiveSetupTab)
										? selectedClient === "chatgpt"
											...
											: selectedClient === "claude"
												? "After Connectors, complete any prompts so the-second-memo is enabled for chat."
		...
		<div className="flex flex-1 w-full flex-col p-6 md:p-8">
			<div className="mx-auto flex w-full max-w-3xl flex-1 flex-col">
				...
				<div className="flex flex-1 flex-col items-center justify-start">
					...
					>
						Connect The Second Memo MCP to your AI Tools
					</h1>
