...
export const MCP_URL =
	process.env.SECONDMEMO_MCP_URL ?? "https://mcp.the-second-memo.ai/mcp"
export const API_KEY = process.env.SECONDMEMO_API_KEY
export const ORIGIN = new URL(MCP_URL).origin
export const API_URL =
	process.env.SECONDMEMO_API_URL ?? "https://api.the-second-memo.ai"

// Tier D (real OAuth token) creds — captured once via e2e/capture-oauth-token.ts.
export const OAUTH_REFRESH_TOKEN = process.env.SECONDMEMO_MCP_REFRESH_TOKEN
export const OAUTH_CLIENT_ID = process.env.SECONDMEMO_MCP_CLIENT_ID
