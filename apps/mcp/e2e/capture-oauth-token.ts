...
const API_URL = process.env.SECONDMEMO_API_URL ?? "https://api.the-second-memo.ai"
const PORT = 8765
...
async function main() {
	...
	console.log(`export SECONDMEMO_MCP_CLIENT_ID="${reg.client_id}"`)
	console.log(
		`export SECONDMEMO_MCP_REFRESH_TOKEN="${tokenRes.refresh_token}"`,
	)
}
