# The Second Memo Pipecat SDK

Memory-enhanced conversational AI pipelines with [The Second Memo](https://the-second-memo.ai) and [Pipecat](https://github.com/pipecat-ai/pipecat).
...
5. **Stores messages** - Sends last user message to The Second Memo (background, non-blocking)

### What Gets Stored

Only the last user message is sent to The Second Memo:
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    # The Second Memo memory service
    memory = The Second MemoPipecatService(
        user_id="alice",
