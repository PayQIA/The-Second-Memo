 ...
 * Tests processors and wrapper with real The Second Memo API calls
 */
...
describe.skipIf(!shouldRunIntegration)(
	...
	() => {
		...
		describe("withThe Second Memo wrapper", () => {
			it("should enhance config with working processors", async () => {
				...
				expect(inputProcessor?.id).toBe("the-second-memo-input")
