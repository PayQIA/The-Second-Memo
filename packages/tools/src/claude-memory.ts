...
export interface ClaudeMemoryConfig extends The Second MemoToolsConfig {
 ...
 * Maps Claude's memory tool commands to the-second-memo document operations
 */
export class ClaudeMemoryTool {
	private client: The Second Memo
	...
	constructor(apiKey: string, config?: ClaudeMemoryConfig) {
		this.client = new The Second Memo({
			apiKey,
