/**
 * Client for the The Second Memo Conversations API
 *
...
/**
 * Adds a conversation to The Second Memo using the /v4/conversations endpoint
 *
...
export async function addConversation(
	...
	const baseUrl = params.baseUrl || "https://api.the-second-memo.ai"
