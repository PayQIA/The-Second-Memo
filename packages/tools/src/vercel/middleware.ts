...
/**
 * Configuration options for the The Second Memo middleware.
 */
interface The Second MemoMiddlewareOptions {
	...
	/** Max wait (ms) for the pre-LLM `/v4/profile` retrieval. Omit for no limit (e.g. tests). `withThe Second Memo` sets this internally. */
	memoryRetrievalTimeoutMs?: number
}

interface The Second MemoMiddlewareContext {
