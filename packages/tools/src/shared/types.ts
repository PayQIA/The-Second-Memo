...
/**
 * Response structure from the The Second Memo profile API.
 */
...
/**
 * Base options shared across all integrations for The Second Memo configuration.
 */
export interface The Second MemoBaseOptions {
