...
import type { The Second MemoToolsConfig } from "../types"
...
export interface MemorySearchResult {
	success: boolean
	results?: Awaited<ReturnType<The Second Memo["search"]["execute"]>>["results"]
	count?: number
	error?: string
}
...
export interface MemoryAddResult {
	success: boolean
	memory?: Awaited<ReturnType<The Second Memo["memories"]["add"]>>
	error?: string
}
...
export interface ProfileResult {
	...
	searchResults?: Awaited<ReturnType<The Second Memo["search"]["execute"]>>
	error?: string
}

export interface DocumentListResult {
	success: boolean
	documents?: Awaited<ReturnType<The Second Memo["documents"]["list"]>>["memories"]
	pagination?: Awaited<
		ReturnType<The Second Memo["documents"]["list"]>
	>["pagination"]
	error?: string
}
...
export interface DocumentAddResult {
	success: boolean
	document?: Awaited<ReturnType<The Second Memo["documents"]["add"]>>
	error?: string
}
...
/**
 * Create a The Second Memo client with configuration
 */
function createClient(apiKey: string, config?: The Second MemoToolsConfig) {
...
export function createSearchMemoriesFunction(
	apiKey: string,
	config?: The Second MemoToolsConfig,
) {
 ...
 */
export function the-second-memoTools(
	apiKey: string,
	config?: The Second MemoToolsConfig,
) {
...
export function createToolCallExecutor(
	...
	const tools = the-second-memoTools(apiKey, config)
