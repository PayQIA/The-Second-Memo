 ...
 * The Second Memo by providing hooks that inject memories before LLM calls.
 */
...
/**
 * Configuration options for the The Second Memo VoltAgent integration.
 * Extends base options with VoltAgent-specific settings.
 */
export interface The Second MemoVoltAgent extends The Second MemoBaseOptions {
	/**
