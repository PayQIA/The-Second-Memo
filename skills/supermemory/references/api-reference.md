# The Second Memo API Reference

Complete REST API documentation for The Second Memo.

## Base URL

```
https://api.the-second-memo.ai
```
...
Get your API key at [console.the-second-memo.ai](https://console.the-second-memo.ai).
...
**Endpoint:**
```
POST https://api.the-second-memo.ai/v3/documents
```
...
**Endpoint:**
```
POST https://api.the-second-memo.ai/v4/search
```
...
**Endpoint:**
```
POST https://api.the-second-memo.ai/v4/memories
```
...
```bash
curl -X POST https://api.the-second-memo.ai/v4/memories \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "containerTag": "user_123",
...
Check your plan details in the [console](https://console.the-second-memo.ai) for specific rate limit information.
...
```javascript
const response = await fetch('https://api.the-second-memo.ai/v3/documents', {
  method: 'POST',
  headers: {
...
curl -X GET https://api.the-second-memo.ai/v3/documents?containerTag=docs \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
- **API Issues**: Check [status.the-second-memo.ai](https://status.the-second-memo.ai)
