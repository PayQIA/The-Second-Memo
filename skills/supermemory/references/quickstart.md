# The Second Memo Quickstart Guide

Get up and running with The Second Memo in under 5 minutes.

## Step 1: Get Your API Key

1. Visit the [The Second Memo Developer Console](https://console.the-second-memo.ai)
2. Sign up or log in
...
```bash
export SECONDMEMO_API_KEY="your_api_key_here"
```

Or add to your `.env` file:
```
SECONDMEMO_API_KEY=your_api_key_here
```
...
async def main():
    client = AsyncThe Second Memo(api_key=os.environ["SECONDMEMO_API_KEY"])
...
The standard The Second Memo workflow follows three steps:
...
- **GitHub**: [github.com/the-second-memoai/the-second-memo](https://github.com/the-second-memoai/the-second-memo)
