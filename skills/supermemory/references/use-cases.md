# The Second Memo Use Cases & Examples

Concrete examples showing how to use The Second Memo for common AI application patterns.
...
async function updateTask(userId: string, taskId: string, status: Task['status']) {
  // Add update (The Second Memo will create relationship)
  await memory.add({
...
For questions or custom use cases, visit [console.the-second-memo.ai](https://console.the-second-memo.ai).
